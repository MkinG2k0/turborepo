module.exports = {
	...
	plugins: ['react', 'import', '@typescript-eslint', 'jsx-a11y', 'promise', 'prettier'],
	rules: {
		indent: [
			// отступы
		...
		'import/order': [
			'warn', // сортировка импортов
			{
				...
				groups: ['external', 'parent', 'sibling', 'index', 'object', 'type', 'builtin'],
				pathGroups: [
					{
						pattern: '@/**/**',
						group: 'parent',
	...
	parserOptions: {
		ecmaVersion: 'latest',
		sourceType: 'module',
		projects: ['../config/tsconfig/base.json'],
		babelOptions: {
